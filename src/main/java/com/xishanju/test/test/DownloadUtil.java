...
public class DownloadUtil {
    ...
    public static void main(String[] args) {
        String path = "http://img.taopic.com/uploads/allimg/140729/240450-140HZP45790.jpg";
        String targetPath = "E:/meituan.jpg";
        final DownloadUtil download = new DownloadUtil(path, targetPath, Runtime.getRuntime().availableProcessors());
        download.download();
